...
function register_custom_taxonomies()
{
    ...
    $labels = array(
        'name' => _x('Direct Investing Capabilities', 'themeblvd'),
        'singular_name' => _x('Direct Investing Capability', 'themeblvd'),
        'search_items' => _x('Search Direct Investing Capabilities', 'themeblvd'),
        'popular_items' => _x('Popular Direct Investing Capabilities', 'themeblvd'),
        'all_items' => _x('All Direct Investing Capabilities', 'themeblvd'),
        'parent_item' => _x('Parent Direct Investing Capability', 'themeblvd'),
        'parent_item_colon' => _x('Parent Direct Investing Capability:', 'themeblvd'),
        'edit_item' => _x('Edit Direct Investing Capability', 'themeblvd'),
        'update_item' => _x('Update Direct Investing Capability', 'themeblvd'),
        'add_new_item' => _x('Add New Direct Investing Capability', 'themeblvd'),
        'new_item_name' => _x('New Direct Investing Capability', 'themeblvd'),
        'add_or_remove_items' => _x('Add or remove Direct Investing Capabilities', 'themeblvd'),
        'choose_from_most_used' => _x('Choose from most used Direct Investing Capabilities', 'themeblvd'),
        'menu_name' => _x('Direct Investing Capabilities', 'themeblvd'),
    );
    ...
    $args = array(
        ...
        'query_var' => 'capability',
    );

    register_taxonomy('capability', array('personnel'), $args);
}
